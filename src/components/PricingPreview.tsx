...
const DEMO_RATES = [
  { icon: 'car-outline' as const, name: 'Mercedes Sedan', rate: '$100/hr' },
  { icon: 'car-sport-outline' as const, name: 'Luxury SUV', rate: '$120/hr' },
  { icon: 'bus-outline' as const, name: 'Sprinter', rate: '$200/hr' },
];
      ...
      {DEMO_RATES.map((vehicle, i) => (
        <View key={vehicle.name}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: spacing.xs }}>
            <Ionicons name={vehicle.icon} size={20} color={colors.gold} />
